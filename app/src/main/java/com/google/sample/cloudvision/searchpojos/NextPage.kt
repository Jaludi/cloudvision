...
class NextPage : Parcelable {
    ...
    companion object {
        val CREATOR: Parcelable.Creator<NextPage> = object : Parcelable.Creator<NextPage> {


            override fun createFromParcel(`in`: Parcel): NextPage {
                val instance = NextPage()
            ...
            override fun newArray(size: Int): Array<NextPage?> {
